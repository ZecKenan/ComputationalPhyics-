  ...
  for jj in range(N):
    ...
    while moved == False:
      ...
      if value == 0 and prev != 1:
        if [posx+1, posy, posz, posw] not in visited:
          prev = 0
          posx += 1
          steps_taken += 1
          visited.append([posx,posy, posz, posw])
        ...
        if [posx, posy+1, posz, posw] not in visited:
          prev = 2
          posy += 1
          steps_taken += 1
          visited.append([posx,posy, posz, posw])
        ...
        if [posx, posy, posz+1, posw] not in visited:
          prev = 4
          posz += 1
          steps_taken += 1
          visited.append([posx,posy, posz, posw])
        ...
        if [posx, posy, posz, posw+1] not in visited:
          prev = 6
          posw += 1
          steps_taken += 1
          visited.append([posx,posy, posz, posw])
